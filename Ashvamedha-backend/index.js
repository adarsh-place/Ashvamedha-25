...
if (process.env.NODE_ENV == "productions") {
  app.use((req, res, next) => {
    const allowedOrigins = ["http://localhost:3000", "https://www.ashvamedha.in" ,"https://ashvamedha.in","https://ashvamedha-25-y3xf.onrender.com" ,"https://k8j373m0-3000.inc1.devtunnels.ms"];
